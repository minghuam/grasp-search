...
public:
    ...
    QPushButton *renderOpenButton;
    QLineEdit *renderPathEdit;
    ...
    void setupUi(QWidget *DBaseDlgUI)
    {
        ...
        exitButton->setGeometry(QRect(380, 570, 75, 24));
        plannerButton = new QPushButton(DBaseDlgUI);
        plannerButton->setObjectName(QString::fromUtf8("plannerButton"));
        plannerButton->setGeometry(QRect(280, 570, 75, 24));
        createGWSButton = new QPushButton(DBaseDlgUI);
        createGWSButton->setObjectName(QString::fromUtf8("createGWSButton"));
        createGWSButton->setGeometry(QRect(180, 570, 75, 24));
        renderOpenButton = new QPushButton(DBaseDlgUI);
        renderOpenButton->setObjectName(QString::fromUtf8("renderOpenButton"));
        renderOpenButton->setGeometry(QRect(360, 490, 75, 24));
        renderPathEdit = new QLineEdit(DBaseDlgUI);
        renderPathEdit->setObjectName(QString::fromUtf8("renderPathEdit"));
        renderPathEdit->setGeometry(QRect(30, 490, 311, 20));
        renderButton = new QPushButton(DBaseDlgUI);
        renderButton->setObjectName(QString::fromUtf8("renderButton"));
        renderButton->setGeometry(QRect(360, 520, 75, 24));
    ...
    void retranslateUi(QWidget *DBaseDlgUI)
    {
        ...
        renderOpenButton->setText(QApplication::translate("DBaseDlgUI", "Open", 0, QApplication::UnicodeUTF8));
        renderPathEdit->setText(QString());
        renderButton->setText(QApplication::translate("DBaseDlgUI", "Render", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
