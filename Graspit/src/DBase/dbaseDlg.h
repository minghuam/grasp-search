...
public:
	DBaseDlg(QWidget *parent = 0) : QDialog(parent), mCurrentLoadedModel(NULL), mDBMgr(NULL), 
        ...
        QObject::connect(renderButton, SIGNAL(clicked()), this, SLOT(renderButton_clicked()));
        QObject::connect(renderOpenButton, SIGNAL(clicked()), this, SLOT(renderOpenButton_clicked()));
...
public slots:
	//! Button events
    void renderOpenButton_clicked();
    void renderButton_clicked();
